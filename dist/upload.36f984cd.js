...
})({"aUMuZ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3ced57a536f984cd";
"use strict";
...
},{}],"idLKm":[function(require,module,exports) {
document.getElementById("btn").addEventListener("click", async function(event) {
    ...
    const firebase = require("2fd58c25fb168d2f");
    const Storage = require("c7bc9b62fa73dc72");
    ...
    var url1, url2;
    await Storage.getDownloadURL(Storage.ref(storage, paper.name + ts)).then((url)=>{
        url1 = url;
    }).catch((error)=>{
        console.log(error);
    });
    await Storage.getDownloadURL(Storage.ref(storage, preview.name + ts)).then((url)=>{
        url2 = url;
    }).catch((error)=>{
        console.log(error);
    });
...
},{"2fd58c25fb168d2f":"aM3Fo","c7bc9b62fa73dc72":"8WX7E"}],"aM3Fo":[function(require,module,exports) {
...
},{"@firebase/app":"3AcPV","@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}],"3AcPV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/component":"bi1VB","@firebase/logger":"fZmft","@firebase/util":"ePiK6","idb":"kozAz","@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}],"bi1VB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/util":"ePiK6","@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}],"ePiK6":[function(require,module,exports) {
/**
 * @license
...
var global = arguments[3];
var process = require("f3d2ebfae39f713c");
const CONSTANTS = {
    /**
...
},{"f3d2ebfae39f713c":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}],"d5jf4":[function(require,module,exports) {
...
},{}],"5aukf":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}],"kozAz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./wrap-idb-value.js":"lS54k","@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}],"lS54k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}],"8WX7E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _storage = require("@firebase/storage");
parcelHelpers.exportAll(_storage, exports);

},{"@firebase/storage":"jEcdO","@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}],"jEcdO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
         ...
         */ const backoffDone = (requestWentThrough, status)=>{
            ...
            if (status.wasSuccessCode) try {
                ...
                if (connection !== null) {
                    ...
                    const err1 = this.appDelete_ ? appDeleted() : canceled();
                    reject(err1);
                } else {
                    const err2 = retryLimitExceeded();
                    reject(err2);
                }
            }
        };
        ...
        case StringFormat.BASE64URL:
            {
                ...
                if (hasPlus || hasSlash) {
                    const invalidChar1 = hasPlus ? "+" : "/";
                    throw invalidFormat(format, "Invalid character '" + invalidChar1 + "' found: is it base64 encoded?");
                }
...
function fromBackendResponse(service, bucket, resource) {
    ...
    if (resource[ITEMS_KEY]) for (const item of resource[ITEMS_KEY]){
        const reference1 = service._makeStorageReference(new Location(bucket, item["name"]));
        listResult.items.push(reference1);
    }
    return listResult;
}
...
},{"@firebase/app":"3AcPV","@firebase/util":"ePiK6","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"5aukf"}]},["aUMuZ","idLKm"], "idLKm", "parcelRequire94c2")

//# sourceMappingURL=upload.36f984cd.js.map
